...
public class Principal extends JFrame implements ActionListener
{
	...
	public Principal() {
		...
		labelBienvenido = new JLabel("Bienvenid@ " + nombreAdmin);
		...
		labelNombre = new JLabel("Nombre y apellido");
		...
		labelfooter = new JLabel("©"+ anioActual.getValue() + " The Coca-Cola Company | Todos los derechos reservados" );
	...
	public void actionPerformed(ActionEvent evento) 
	{
		if(evento.getSource() == miCalculo) 
		{
			...
			{
				JOptionPane.showMessageDialog(null, "Se requiere llenar todos los campos por favor.");
			} 
			else 
			{
		...
		{
			JOptionPane.showMessageDialog(null, "Desarrollado por Matias cuando practicaba Java Basico\n" + " Siendo este mi primer programa complejo");
