...
public class Licencia extends JFrame implements ActionListener, ChangeListener {
	...
	public Licencia() {
		...
		textarea1.setText("\n\n          Mi primer proyecto medianamente complejo" +
						  "\n            a pesar de hacerlo en practica tuve que hacerlo a mi manera y buscar soluciones por mi parte :)" + 
						  "\n             PD: Tambien le agregue unas opciones mas para que sea mas optimo el trabajo");
